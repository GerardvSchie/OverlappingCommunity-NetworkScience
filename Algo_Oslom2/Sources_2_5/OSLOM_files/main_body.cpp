...
int main(int argc, char * argv[]) {
  ...
  string path = directory_char;
  string suffix = "_oslo_files";
  string res_path = path + suffix;
  char res_path_char[1000];
  cast_string_to_char(res_path, res_path_char);
  mkdir(res_path_char, S_IRWXU);
